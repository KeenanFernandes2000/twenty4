...
ALTER TABLE "users" ALTER COLUMN "auth_provider" SET DEFAULT 'email';--> statement-breakpoint
...
CREATE UNIQUE INDEX "users_username_uq" ON "users" USING btree ("username") WHERE "users"."username" is not null;